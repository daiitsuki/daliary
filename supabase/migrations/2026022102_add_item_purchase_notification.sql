-- 1. Add notify_item_purchased to notification_settings
ALTER TABLE public.notification_settings 
ADD COLUMN IF NOT EXISTS notify_item_purchased BOOLEAN DEFAULT TRUE;

-- 2. Update handle_notification_trigger to handle item purchases
...
-- 3. Create trigger for point_history
...
-- 4. Update get_app_init_data to include notify_item_purchased
...
BEGIN
  ...
  -- 3. Notification Settings (Included notify_item_purchased)
  SELECT 
    is_enabled, 
