-- ==========================================
-- Migration: Fix Notification Settings & RPC Sync
-- Date: 2026-02-19
-- Description: Adds notify_trip_change, removes notify_visit_comment, 
--              and updates RPC to match frontend expectations.
-- ==========================================
...
-- 2. Update handle_notification_trigger (Ensure idempotency with CREATE OR REPLACE)
...
-- 3. Update Foundation RPC (get_app_init_data) - Critical for Frontend Sync
...
BEGIN
  ...
  -- 3. Notification Settings (Updated columns: notify_trip_change added, notify_visit_comment removed)
  SELECT 
    is_enabled, 
