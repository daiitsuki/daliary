-- Migration: 2026030206_fix_notification_trigger_safety.sql
-- Goal: Fix potential crash in handle_notification_trigger when notification settings are missing
-- This version also preserves Game Rewards, Trip Changes, and deep-link metadata from previous migrations.
