...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-6 md:bottom-4 left-1/2 -translate-x-1/2 w-fit bg-gradient-to-b from-white/40 to-white/10 backdrop-blur-[32px] border border-white/50 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.1),0_1px_2px_rgba(255,255,255,0.5)_inset] p-1.5 md:p-1.5 flex items-center gap-1.5 md:gap-4 z-40 transition-all duration-700 hover:from-white/50 hover:to-white/20">
      <button
        onClick={() => navigate("/")}
        className={`relative flex flex-col items-center px-4.5 py-3 md:px-5 md:py-2.5 rounded-full transition-all duration-500 ${
