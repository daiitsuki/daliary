...
export default function CoupleSettingsSection({
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="bg-white p-5 sm:p-6 rounded-[28px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-rose-100/30 space-y-5">
        ...
        {!isCoupleFormed && (
          <div className="pt-5 border-t border-gray-50 flex flex-col items-center text-center">
            <span className="text-[15px] font-semibold text-gray-800 tracking-tight mb-3">
              우리의 연결 코드
            </span>
            <div className="w-full bg-rose-50/30 border border-rose-100/50 p-4 rounded-[20px] group hover:bg-rose-50/50 transition-all">
              <p className="font-mono text-xl sm:text-2xl font-bold text-rose-500 tracking-[0.3em] tabular-nums">
                {couple?.invite_code || "------"}
              </p>
            </div>
            <p className="mt-3.5 text-[12px] font-medium text-gray-400 leading-relaxed">
              상대방의 앱에 이 코드를 입력하면
              <br />
              함께 달이어리를 쓸 수 있어요.
            </p>
