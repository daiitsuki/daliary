...
const HeartGauge = () => {
  ...
  return (
    <div className="px-6 mb-8">
      <motion.div
        whileTap={{ scale: 0.98 }}
        className="bg-white rounded-[28px] p-5 shadow-sm border border-rose-50 cursor-pointer group relative overflow-hidden"
      >
        <div onClick={() => handleOpenModal("history")}>
          <div className="flex justify-between items-end mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p
                  className={`text-[10px] font-black uppercase tracking-widest leading-none mb-1.5 ${hasCheckedIn ? "text-rose-400" : "text-gray-300"}`}
                >
            ...
            <div className="text-right flex flex-col items-end">
              <p className="text-[12px] font-black text-rose-500 mb-0.5">
          ...
          <div className="mt-3.5 flex items-center justify-between">
            <p className="text-[11px] text-gray-500 font-bold">
              누적 {totalPoints} PT · 다음 레벨까지{" "}
              {levelInfo.nextLevelExp - levelInfo.currentExp} PT
            </p>
            <ChevronRight
              size={16}
